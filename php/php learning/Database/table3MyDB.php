...
//Make a table with FirstName and LastName as table Headers. Call all entries where data matches SQL query
$result = mysqli_query($con,"SELECT FirstName, LastName FROM Persons WHERE FirstName='Christopher'");
echo "<table border='1'>
<tr>
<th>FirstName</th>
<th>LastName</th>
